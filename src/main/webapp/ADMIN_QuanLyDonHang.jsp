        ...
        <table class="table table-bordered table-striped text-center">
            <thead class="table-dark">
                <tr class="align-middle">
                    <th>Mã Hóa Đơn</th>
                    <th>Mã Tài Khoản Đặt Hàng</th>
                    <th>Phương Thức Thanh Toán</th>
                    <th>Tổng Tiền</th>
                    <th>Ngày Lập</th>
                    <th>Tên Người Nhận</th>
                    <th>Số Điện Thoại Người Nhận</th>
                    <th>Thành Phố Người Nhận</th>
                    <th>Địa Chỉ Nhà Người Nhận</th>
            ...
            <tbody>
                <c:forEach var="hd" items="${dsHoaDon}">
                    <tr class="align-middle">
                        ...
                        <td>
	                        <c:choose>
						        <c:when test="${hd.xacNhanThanhToan == 0}">
                        ...
                        <td>
							<div class="d-inline-flex align-items-center">
								<form action="HienThiChiTietHoaDon" method="post">
							        <input type="hidden" name="maHoaDon" value="${hd.maHoaDon}" />
							        <button type="submit" class="btn btn-outline-info me-2"><i class="bi bi-info-circle-fill"></i></button>
						        </form>
							    <form action="XoaDonHang" method="post">
							        <input type="hidden" name="delete" value="delete"> 
							        <input type="hidden" name="mahoadonxoa" value="${hd.getMaHoaDon() }">
							        <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Bạn có chắc muốn xóa đơn hàng này?');">
