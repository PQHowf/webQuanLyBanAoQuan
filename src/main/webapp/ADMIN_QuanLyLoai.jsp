...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link active active-style" aria-current="page" href="QuanLyLoai">QUẢN LÝ LOẠI</a></li>
	...
	<div class="container mt-5">
        <h2 class="text-center">DANH SÁCH LOẠI</h2>
        <div class="d-flex">
		    <a href="ThemLoai" class="btn btn-outline-success me-3 mb-3">
		        <span class="bi bi-plus-circle"> THÊM LOẠI</span>
		    </a>
                    ...
                    <tr class="align-middle">
                        ...
                        <td>
							<div class="d-inline-flex align-items-center">
							    <!-- Form chỉnh sửa -->
							    <form action="SuaLoai_HienThiForm" method="post" class="me-2">
							        <input type="hidden" name="chinhsua" value="edit"> 
							        <input type="hidden" name="maloaisua" value="${l.getMaLoai() }">
							    ...
							    <!-- Form xóa -->
							    <form action="XoaLoai" method="post">
							        <input type="hidden" name="delete" value="delete"> 
							        <input type="hidden" name="maloaixoa" value="${l.getMaLoai() }">
							        <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Bạn có chắc muốn xóa loại này?');">
