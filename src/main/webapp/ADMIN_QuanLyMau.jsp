...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link active active-style" aria-current="page" href="QuanLyMau">QUẢN LÝ MÀU</a></li>
	...
	<div class="container mt-5">
        <h2 class="text-center">DANH SÁCH MÀU</h2>
        <div class="d-flex">
		    <a href="ThemMau" class="btn btn-outline-success me-3 mb-3">
		        <span class="bi bi-plus-circle"> THÊM MÀU</span>
		    </a>
                    ...
                    <tr class="align-middle">
                        ...
                        <td>
							<div class="d-inline-flex align-items-center">
							    <!-- Form chỉnh sửa -->
							    <form action="SuaMau_HienThiForm" method="post" class="me-2">
							        <input type="hidden" name="chinhsua" value="edit"> 
							        <input type="hidden" name="mamausua" value="${m.getMaMau() }">
							    ...
							    <!-- Form xóa -->
							    <form action="XoaMau" method="post">
							        <input type="hidden" name="delete" value="delete"> 
							        <input type="hidden" name="mamauxoa" value="${m.getMaMau() }">
							        <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Bạn có chắc muốn xóa màu này?');">
