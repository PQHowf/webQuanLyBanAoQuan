...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link active active-style" aria-current="page" href="QuanLyTaiKhoan">QUẢN LÝ TÀI KHOẢN</a></li>
	...
	<div class="container mt-5">
        ...
        <div class="d-flex">
		    <a href="ThemTaiKhoan" class="btn btn-outline-success me-3 mb-3">
		        <span class="bi bi-plus-circle"> THÊM TÀI KHOẢN</span>
		    </a>
                    ...
                    <tr class="align-middle">
                        ...
                        <td>
							<div class="d-inline-flex align-items-center">
							    <!-- Form chỉnh sửa -->
							    <form action="SuaTaiKhoan_HienThiForm" method="post" class="me-2">
							        <input type="hidden" name="chinhsua" value="edit"> 
							        <input type="hidden" name="mataikhoansua" value="${tk.getIDTaiKhoan() }">
							    ...
							    <form action="XoaTaiKhoan" method="post">
							        ...
							        <input type="hidden" name="mataikhoanxoa" value="${tk.getIDTaiKhoan() }">
							        <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Bạn có chắc muốn xóa tài khoản này?');">
