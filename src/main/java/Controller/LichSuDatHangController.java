...
/**
 * Servlet implementation class LichSuDatHangController
 */
...
public class LichSuDatHangController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<HoaDon> dsHoaDon = hddao.LayThongTinChiTietHoaDon(IDTaiKhoan);

            request.setAttribute("dsHoaDon", dsHoaDon);
            request.getRequestDispatcher("LichSuDatHang.jsp").forward(request, response);
