	...
	<div class="container mt-4">
		...
		<form action="SuaLoai" method="post">
			<div class="mb-3">
		    	...
		    	<input type="text" class="form-control" name="maloaisua" value="${loaiSua.maLoai }" readonly>
			</div>
			<div class="mb-3">
		    	<label class="form-label">Tên loại:</label>
		    	<input type="text" class="form-control" name="tenloaisua" value="${loaiSua.tenLoai }" required>
			</div>
			<div class="text-end">
